// ------------------------------------------------------------------------------------------------
//  <copyright file="ReviewStatusDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    /// <summary>
    /// Deserializes the JSON wire representation of <see cref="ReviewStatus" />.
    /// </summary>
    [GeneratedCode("Mycelium.SDK", "latest")]
    internal static class ReviewStatusDeSerializer
    {
        /// <summary>
        /// Deserializes a required exact-uppercase
        /// <see cref="ReviewStatus" /> value.
        /// </summary>
        /// <param name="reader">
        ...
        /// </exception>
        internal static ReviewStatus DeSerialize(
            ref Utf8JsonReader reader)
        {
            var value = Utf8JsonReaderHelper.ReadRequiredString(ref reader);

            if (ReviewStatusProvider.TryParse(value, out var result)
                && string.Equals(
                    value,
                    ReviewStatusProvider.Format(result).ToUpperInvariant(),
            ...
            throw new JsonException(
                $"'{value}' is not a valid uppercase ReviewStatus JSON value.");
        }
        ...
        /// representation of a defined literal.
        /// </exception>
        internal static ReviewStatus? DeSerializeOrNull(
            ref Utf8JsonReader reader)
        {
