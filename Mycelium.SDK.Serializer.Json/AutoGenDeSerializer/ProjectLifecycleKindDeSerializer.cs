// ------------------------------------------------------------------------------------------------
//  <copyright file="ProjectLifecycleKindDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    /// <summary>
    /// Deserializes the JSON wire representation of <see cref="ProjectLifecycleKind" />.
    /// </summary>
    [GeneratedCode("Mycelium.SDK", "latest")]
    internal static class ProjectLifecycleKindDeSerializer
    {
        /// <summary>
        /// Deserializes a required exact-uppercase
        /// <see cref="ProjectLifecycleKind" /> value.
        /// </summary>
        /// <param name="reader">
        ...
        /// </exception>
        internal static ProjectLifecycleKind DeSerialize(
            ref Utf8JsonReader reader)
        {
            ...
            throw new JsonException(
                $"'{value}' is not a valid uppercase ProjectLifecycleKind JSON value.");
        }
        ...
        /// representation of a defined literal.
        /// </exception>
        internal static ProjectLifecycleKind? DeSerializeOrNull(
            ref Utf8JsonReader reader)
        {
