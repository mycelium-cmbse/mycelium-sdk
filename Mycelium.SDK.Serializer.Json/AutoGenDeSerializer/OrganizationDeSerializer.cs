...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    {
        /// <summary>
        /// Deserializes an exact <see cref="Organization" /> instance.
        /// </summary>
        /// <param name="reader">
        ...
        internal static IThing DeSerialize(ref Utf8JsonReader reader, ILoggerFactory loggerFactory = null)
        {
            ...
            var logger = loggerFactory == null
                ? NullLogger.Instance
                : loggerFactory.CreateLogger("OrganizationDeSerializer");
            ...
            while (reader.Read())
            {
                ...
                if (reader.ValueTextEquals("@type"u8))
                {
                    ...
                    if (!string.Equals(typeName, "Organization", StringComparison.Ordinal))
                    {
                        throw new NotSupportedException($"JSON discriminator '{typeName}' is not supported by OrganizationDeSerializer.");
                    }
                ...
                if (reader.ValueTextEquals("involvedUser"u8))
                {
                    Utf8JsonReaderHelper.ReadNext(ref reader);
                    ...
                    while (reader.Read())
                    {
                        ...
                        dto.InvolvedUser.Add(Utf8JsonReaderHelper.ReadGuid(ref reader));
                    }

                    if (!hasEndArray)
                    {
                        throw new JsonException("The involvedUser array is incomplete.");
                    }
                ...
                if (reader.ValueTextEquals("projects"u8))
                {
                    Utf8JsonReaderHelper.ReadNext(ref reader);
                    ...
                    while (reader.Read())
                    {
                        ...
                        dto.Projects.Add(Utf8JsonReaderHelper.ReadGuid(ref reader));
                    }

                    if (!hasEndArray)
                    {
                        throw new JsonException("The projects array is incomplete.");
                    }
