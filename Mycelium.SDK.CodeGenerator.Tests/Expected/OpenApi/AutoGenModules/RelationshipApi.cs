...
namespace Mycelium.Fabric.ConcurrentServer.Modules
{
    ...
    /// <summary>
    /// Provides the Relationship routes that the OMG Systems Modeling API and Services
    ...
    public partial class RelationshipApi : ICarterModule
    {
        /// <inheritdoc />
        public void AddRoutes(IEndpointRouteBuilder app)
        {
            app.MapGet("/projects/{projectId:guid}/commits/{commitId:guid}/elements/{relatedElementId:guid}/relationships", GetRelationshipsByProjectCommitRelatedElement)
                .WithName("getRelationshipsByProjectCommitRelatedElement")
                .WithSummary("Get relationships by project, commit, and related element")
                .WithTags("Relationship");
        }
    }
}
