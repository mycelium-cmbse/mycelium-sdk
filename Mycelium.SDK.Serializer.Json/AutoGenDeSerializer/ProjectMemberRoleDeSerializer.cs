// ------------------------------------------------------------------------------------------------
//  <copyright file="ProjectMemberRoleDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    /// <summary>
    /// Deserializes the JSON wire representation of <see cref="ProjectMemberRole" />.
    /// </summary>
    [GeneratedCode("Mycelium.SDK", "latest")]
    internal static class ProjectMemberRoleDeSerializer
    {
        /// <summary>
        /// Deserializes a required exact-uppercase
        /// <see cref="ProjectMemberRole" /> value.
        /// </summary>
        /// <param name="reader">
        ...
        /// </exception>
        internal static ProjectMemberRole DeSerialize(
            ref Utf8JsonReader reader)
        {
            var value = Utf8JsonReaderHelper.ReadRequiredString(ref reader);

            if (ProjectMemberRoleProvider.TryParse(value, out var result)
                && string.Equals(
                    value,
                    ProjectMemberRoleProvider.Format(result).ToUpperInvariant(),
            ...
            throw new JsonException(
                $"'{value}' is not a valid uppercase ProjectMemberRole JSON value.");
        }
        ...
        /// representation of a defined literal.
        /// </exception>
        internal static ProjectMemberRole? DeSerializeOrNull(
            ref Utf8JsonReader reader)
        {
