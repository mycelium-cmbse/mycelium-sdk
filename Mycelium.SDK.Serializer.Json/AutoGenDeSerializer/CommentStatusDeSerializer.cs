// ------------------------------------------------------------------------------------------------
//  <copyright file="CommentStatusDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    /// <summary>
    /// Deserializes the JSON wire representation of <see cref="CommentStatus" />.
    /// </summary>
    [GeneratedCode("Mycelium.SDK", "latest")]
    internal static class CommentStatusDeSerializer
    {
        /// <summary>
        /// Deserializes a required exact-uppercase
        /// <see cref="CommentStatus" /> value.
        /// </summary>
        /// <param name="reader">
        ...
        /// </exception>
        internal static CommentStatus DeSerialize(
            ref Utf8JsonReader reader)
        {
            var value = Utf8JsonReaderHelper.ReadRequiredString(ref reader);

            if (CommentStatusProvider.TryParse(value, out var result)
                && string.Equals(
                    value,
                    CommentStatusProvider.Format(result).ToUpperInvariant(),
            ...
            throw new JsonException(
                $"'{value}' is not a valid uppercase CommentStatus JSON value.");
        }
        ...
        /// representation of a defined literal.
        /// </exception>
        internal static CommentStatus? DeSerializeOrNull(
            ref Utf8JsonReader reader)
        {
