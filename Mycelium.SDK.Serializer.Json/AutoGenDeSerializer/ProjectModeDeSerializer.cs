// ------------------------------------------------------------------------------------------------
//  <copyright file="ProjectModeDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    /// <summary>
    /// Deserializes the JSON wire representation of <see cref="ProjectMode" />.
    /// </summary>
    [GeneratedCode("Mycelium.SDK", "latest")]
    internal static class ProjectModeDeSerializer
    {
        /// <summary>
        /// Deserializes a required exact-uppercase
        /// <see cref="ProjectMode" /> value.
        /// </summary>
        /// <param name="reader">
        ...
        /// </exception>
        internal static ProjectMode DeSerialize(
            ref Utf8JsonReader reader)
        {
            var value = Utf8JsonReaderHelper.ReadRequiredString(ref reader);

            if (ProjectModeProvider.TryParse(value, out var result)
                && string.Equals(
                    value,
                    ProjectModeProvider.Format(result).ToUpperInvariant(),
            ...
            throw new JsonException(
                $"'{value}' is not a valid uppercase ProjectMode JSON value.");
        }
        ...
        /// representation of a defined literal.
        /// </exception>
        internal static ProjectMode? DeSerializeOrNull(
            ref Utf8JsonReader reader)
        {
