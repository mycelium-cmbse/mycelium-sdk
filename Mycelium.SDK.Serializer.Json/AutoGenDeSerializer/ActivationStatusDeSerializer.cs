// ------------------------------------------------------------------------------------------------
//  <copyright file="ActivationStatusDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.SDK.Serializer.Json
{
    ...
    /// <summary>
    /// Deserializes the JSON wire representation of <see cref="ActivationStatus" />.
    /// </summary>
    [GeneratedCode("Mycelium.SDK", "latest")]
    internal static class ActivationStatusDeSerializer
    {
        /// <summary>
        /// Deserializes a required exact-uppercase
        /// <see cref="ActivationStatus" /> value.
        /// </summary>
        /// <param name="reader">
        ...
        /// </exception>
        internal static ActivationStatus DeSerialize(
            ref Utf8JsonReader reader)
        {
            var value = Utf8JsonReaderHelper.ReadRequiredString(ref reader);

            if (ActivationStatusProvider.TryParse(value, out var result)
                && string.Equals(
                    value,
                    ActivationStatusProvider.Format(result).ToUpperInvariant(),
            ...
            throw new JsonException(
                $"'{value}' is not a valid uppercase ActivationStatus JSON value.");
        }
        ...
        /// representation of a defined literal.
        /// </exception>
        internal static ActivationStatus? DeSerializeOrNull(
            ref Utf8JsonReader reader)
        {
