...
namespace Mycelium.Fabric.ConcurrentServer.Modules
{
    ...
    /// <summary>
    /// Provides the Project routes that the OMG Systems Modeling API and Services
    ...
    public partial class ProjectApi : ICarterModule
    {
        /// <summary>
        ...
        {
            app.MapGet("/projects", GetProjects)
                .WithName("getProjects")
                .WithSummary("Get projects")
                .WithTags("Project");

            app.MapPost("/projects", PostProject)
                .WithName("postProject")
                .WithSummary("Create project")
                .WithTags("Project");

            app.MapGet("/projects/{projectId:guid}", GetProjectById)
                .WithName("getProjectById")
                .WithSummary("Get project by ID")
                .WithTags("Project");

            app.MapPut("/projects/{projectId:guid}", PutProjectById)
                .WithName("putProjectById")
                .WithSummary("Update project by ID")
                .WithTags("Project");

            app.MapDelete("/projects/{projectId:guid}", DeleteProjectById)
